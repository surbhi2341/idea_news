    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 md:p-8 rounded-lg shadow-sm space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-lg font-bold text-slate-800 dark:text-slate-200">Sign In to Your Account</h2>
          <p className="text-xs text-slate-400">Read, write, publish, and moderate regional articles.</p>
        </div>
        ...
        <div className="text-center text-xs text-slate-500">
          New to Ideaciti News Network? <Link to="/register" className="text-red-650 font-bold hover:underline">Create Account</Link>
        </div>
